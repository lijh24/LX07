    ...
    public class WorkInfo
    {
        ...
        public IEnumerable<Model.WorkInfoNo> GetPage(Model.WorkPage page)
        {
            using (IDbConnection cn = new MySqlConnection(cns))
            {
                ...
                return cn.Query<Model.WorkInfoNo>(sql, new { pageIndex=page.pageIndex,page=page.pageSize,activityIds=page.activityIds});
            }
        }
        ...
        public int Add(Model.WorkInfoNo workinfo)
        {
            using (IDbConnection cn = new MySqlConnection(cns))
            {
